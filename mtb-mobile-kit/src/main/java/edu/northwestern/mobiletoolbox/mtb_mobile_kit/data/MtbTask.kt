...
import edu.northwestern.mobiletoolbox.mtb_mobile_kit.enums.ScreenOrientation
import edu.northwestern.mobiletoolbox.mtb_mobile_kit.enums.ScreenOrientation.portrait
...
data class MtbTask(
    ...
    override fun copyWithSteps(steps: MutableList<Step>?): MtbTask {
    ...
    override fun copyWithAsyncActions(asyncActions: MutableSet<AsyncActionConfiguration>?): MtbTask {
